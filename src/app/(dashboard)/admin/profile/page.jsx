  ...
  return (
    <AdminLayout>
      <div
        ...
        className="sm:p-10 p-5 min-h-screen rounded-md text-white"
      >
        <Toaster position="top-center" reverseOrder={false} />

        <div className="w-full text-[#FFFFFFB2] flex flex-col sm:flex-row sm:items-start sm:gap-x-7 justify-start">
          {/* Tabs */}
              ...
              <div>
                <div className="space-y-4 max-w-lg">
                  ...
                  <div>
                    <label
                      htmlFor="password"
                      className="block text-sm font-medium text-[#FFFFFFB2]"
                    >
                      Password
                    </label>
                    <div className="flex items-center">
