...
const DeleteTicketPopup = ({ selectedTickets, onDelete, onClose }) => {
  const handleDelete = () => {
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white p-6 rounded-lg max-w-[400px] md:w-[400px] shadow-lg">
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-2xl font-semibold text-gray-800">Delete Ticket</h2>
        </div>
        <p className="text-gray-700 mb-4">
          {selectedTickets.length > 1
            ? `Are you sure you want to delete these ${selectedTickets.length} tickets?`
