...
const EditUserPopup = ({ isOpen, userData, onClose, onSave }) => {
  ...
  useEffect(() => {
    if (userData) {
      ...
      setUserType(userData.userType); // Set the default value for userType
        ...
        <div className="space-y-4">
          ...
          <div>
            <Select
              ...
              selectValue={userType} // Use the `userType` state as the default value
